...
export enum CollectibleTypeLabUpgrade {
  ...
  COLLECTIBLE_BLUEFRIENDSBOX = Isaac.GetItemIdByName("Blue Friends' Box"),
  COLLECTIBLE_ENERGIZEDMEGABLAST = Isaac.GetItemIdByName(
    "Energized Mega Satan's Breath",
  ),
  ...
  COLLECTIBLE_SPRINKLERS = Isaac.GetItemIdByName("Sprinklers"),
  COLLECTIBLE_SHARPENEDMEATCLEAVER = Isaac.GetItemIdByName(
  ...
  COLLECTIBLE_SUPERBALL = Isaac.GetItemIdByName("Super Ball"),
  COLLECTIBLE_ENERGIZEDCONVERTER = Isaac.GetItemIdByName("Energized Converter"),
  COLLECTIBLE_NECROMANTICSHOVEL = Isaac.GetItemIdByName("Necromantic Shovel"),
  COLLECTIBLE_GOLDPLATER = Isaac.GetItemIdByName("Gold Plater"),
...
export const CollectibleUpgrade: Map<number, number[]> = new Map([
  ...
  [
    ...
    [CollectibleType.COLLECTIBLE_R_KEY as number],
  ],
  [
  ...
  [
    ...
    [CollectibleType.COLLECTIBLE_SUPLEX as number],
  ],
  [
    CollectibleType.COLLECTIBLE_SUPLEX,
    [CollectibleType.COLLECTIBLE_BERSERK as number],
  ],
  [
    CollectibleType.COLLECTIBLE_ANIMA_SOLA,
    [CollectibleType.COLLECTIBLE_ESAU_JR as number],
  ],
  [
    CollectibleType.COLLECTIBLE_VOID,
    [CollectibleType.COLLECTIBLE_ABYSS as number],
  ],
  [
