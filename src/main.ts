...
import * as EFF_BLUEFRIENDSBOX from "./items/active/upgraded/b/blueFriendsBox";
...
import * as EFF_BRIMSTONECANNON from "./items/active/upgraded/b/brimstoneCannon";
...
import * as EFF_SINGULARITYGENERATOR from "./items/active/upgraded/s/singularityGenerator";
